            ...
            try
            {
                ...
                foreach (var item in fileDetails)
                {
                    ...
                    else
                    {
                        ...
                        //string filePath = "C:\\Users\\EUGENE\\OneDrive\\Documents\\sms.txt"; // Replace with the actual path to your text file
                        string[] smss;
                        ...
                        //UserFunctions.WriteToSheet(tempSave, tempSave, removedDuplicate, duplicateRemoved, smss[counter],  out message);
                ...
                //var workbook = new Aspose.Cells.Workbook(tempSave+"Report"+"."+"xlsx");
                //UserFunctions.DeleteWorksheetOne(workbook, tempSave);
